...
REGISTER /root/hive_try_local/GetAgeBucket.jar;
REGISTER /root/hive_try_local/elasticsearch-hadoop-2.0.0.jar;
...
STORE union_d INTO 'dashboard/caoincifull' USING org.elasticsearch.hadoop.pig.EsStorage();
